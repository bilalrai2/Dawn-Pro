...
class Dawn:
    ...
    def welcome(self):
        print(
            f"""
        {Fore.GREEN + Style.BRIGHT}Auto Setup {Fore.BLUE + Style.BRIGHT}Dawn - Pro
            """
            f"""
        {Fore.GREEN + Style.BRIGHT} Telegram Channel {Fore.YELLOW + Style.BRIGHT} > https://t.me/BilalStudio3
            """
        )
...
if __name__ == "__main__":
    try:
        ...
        print(
            ...
            f"{Fore.RED + Style.BRIGHT}[ EXIT ] Dawn - Pro {Style.RESET_ALL}                                      ",                                       
        )